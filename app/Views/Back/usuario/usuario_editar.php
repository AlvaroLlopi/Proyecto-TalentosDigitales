<body class="gradient-custom">
    <div class="container mt-5">
        ...
        <div class="card col-lg-3 bg-dark" style="width: 50%; color:white">
            ...
            <?php if (isset($user)): ?>
                <center><form action="<?= base_url("/usuarios/update/{$user['id_usuario']}") ?>" method="post">
                    ...
                    <br>
                    <label for="perfil_id">Perfil: 1-Admin 2-Cliente</label>
                    <input type="number" name="perfil_id" value="<? $user['perfil_id']?>"><br>
                    <br>
