                ...
                <br>
                    ...
                    <form method="post" action="<?php echo base_url('/enviar-formu') ?>">
                        ...
                        <div class="card-body justify-content-center" media="(max-width:768px)">
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Categoria: 1-Interno 2-Externo</label>
                                <input name="categoria_id" type="number" class="form-control" placeholder="Categoria">
