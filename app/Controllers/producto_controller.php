...
class Producto_controller extends Controller{
    ...
    public function create(){
        ...
        echo view('back/usuario/registroproducto');
    ...
    public function formValidation()
    {
        $input = $this->validate([
            ...
            'categoria_id' => 'required|in_list[1,2]',
        ...
        if (!$input) {
            ...
            echo view('front/navbar');
            echo view('back/usuario/registroproducto', ['validation' => $this->validator]);
            echo view('front/footer');
        } else {
            $formModel->save([
    ...
    public function ListadoProducto() {
        ...
        echo view('front/header', $data);
        echo view('front/navbar');
        echo view('back/usuario/producto_listado', $data); // Vista para mostrar la lista de productos
        echo view('front/footer');
    }
    ...
    public function editarproducto($id_producto) {
        ...
        echo view('front/header', $data);
        echo view('front/navbar');
        echo view('back/usuario/producto_editar', $data); // Vista para editar el producto
        echo view('front/footer');
    }
    ...
    public function update($id_producto) {
        ...
        if (!$input) {
            ...
            echo view('front/header', $data);
            echo view('front/navbar');
            echo view('back/usuario/producto_editar', ['validation' => $this->validator, 'producto' => $data['producto']]);
            echo view('front/footer');
        } else {
            $data = [
                'nombre' => $this->request->getVar('nombre'),
